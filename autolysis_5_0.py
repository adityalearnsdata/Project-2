...
def generate_prompt(data_analysis, value_counts, image_files):
    """Generates the prompt for the LLM with all image files included."""
    ...
    pca_analysis = data_analysis.get("pca_explained_variance", "PCA analysis not available.")
    pca_components = data_analysis.get("pca_components", "PCA components not available.")
    ...
    ### Visualizations:
    - Correlation Matrix: See attached image `correlation_matrix.png`
    - PCA Explained Variance: See attached image `pca_variance.png`
    ...
    for image in image_files:
        if os.path.exists(image):
            prompt += f" - Image: See attached image `{image}`\n"
